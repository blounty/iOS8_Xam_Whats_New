...
@implementation AppDelegate { } 
	...
	-(id) window
	{
		...
		return native_to_managed_trampoline_1 (self, _cmd, &managed_method, "Settings.AppDelegate, Settings, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "get_Window");
	}

	-(void) setWindow:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIWindow, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "Settings.AppDelegate, Settings, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "set_Window");
	}

	-(void) applicationWillResignActive:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIApplication, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "Settings.AppDelegate, Settings, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "OnResignActivation");
	}

	-(void) applicationDidEnterBackground:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIApplication, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "Settings.AppDelegate, Settings, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "DidEnterBackground");
	}

	-(void) applicationWillEnterForeground:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIApplication, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "Settings.AppDelegate, Settings, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "WillEnterForeground");
	}

	-(void) applicationWillTerminate:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIApplication, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "Settings.AppDelegate, Settings, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "WillTerminate");
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_4 (self, _cmd, &managed_method, "Settings.AppDelegate, Settings, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", ".ctor");
	}
@end
...
@implementation SettingsViewController { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_5 (self, _cmd, &managed_method, "Settings.SettingsViewController, Settings, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "DidReceiveMemoryWarning");
	}

	-(void) viewDidLoad
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_5 (self, _cmd, &managed_method, "Settings.SettingsViewController, Settings, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewDidLoad");
	}

	-(void) viewWillAppear:(bool)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "Settings.SettingsViewController, Settings, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewWillAppear");
	}

	-(void) viewDidAppear:(bool)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "Settings.SettingsViewController, Settings, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewDidAppear");
	}

	-(void) viewWillDisappear:(bool)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "Settings.SettingsViewController, Settings, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewWillDisappear");
	}

	-(void) viewDidDisappear:(bool)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "Settings.SettingsViewController, Settings, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewDidDisappear");
	}

	-(void) UIButton5_TouchUpInside:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIButton, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "Settings.SettingsViewController, Settings, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "UIButton5_TouchUpInside");
	}
...
@end
	...
	static MTClassMap __monotouch_class_map [] = {
		...
		{"AppDelegate", "Settings.AppDelegate, Settings, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", NULL },
		...
		{"SettingsViewController", "Settings.SettingsViewController, Settings, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", NULL },
...
void monotouch_create_classes () {
	...
	__monotouch_class_map [4].handle = [SettingsViewController class];
	__monotouch_class_map [5].handle = objc_getClass ("NSArray");
	__monotouch_class_map [6].handle = objc_getClass ("NSString");
	__monotouch_class_map [7].handle = objc_getClass ("NSURL");
	__monotouch_class_map [8].handle = objc_getClass ("UIApplication");
	__monotouch_class_map [9].handle = objc_getClass ("UIView");
	__monotouch_class_map [10].handle = objc_getClass ("UIControl");
	__monotouch_class_map [11].handle = objc_getClass ("UIButton");
	__monotouch_class_map [12].handle = objc_getClass ("UIDevice");
	__monotouch_class_map [13].handle = objc_getClass ("UIWindow");
	__monotouch_class_map [14].handle = objc_getClass ("UITraitCollection");
	__monotouch_class_map [15].handle = objc_getClass ("NSException");
	__monotouch_class_map [16].handle = objc_getClass ("__NSObject_Disposer");
	monotouch_setup_classmap (__monotouch_class_map, 17);
}
