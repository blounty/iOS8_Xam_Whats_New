...
bool native_to_managed_trampoline_3 (id self, SEL _cmd, MonoMethod **managed_method_ptr, id p0, NSString * p1, const char *r0, const char *r1, const char *r2, const char *r3)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [2];
	MonoObject *mthis;
...
bool native_to_managed_trampoline_4 (id self, SEL _cmd, MonoMethod **managed_method_ptr, id p0, id p1, void * p2, const char *r0, const char *r1, const char *r2, const char *r3, const char *r4)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [3];
	MonoObject *mthis;
...
@interface AppDelegate : NSObject/*<UIApplicationDelegate>*/ {
	...
	-(bool) application:(id)p0 willContinueUserActivityWithType:(NSString *)p1;
	-(bool) application:(id)p0 continueUserActivity:(id)p1 restorationHandler:(void *)p2;
...
@implementation AppDelegate { } 
	...
	-(id) window
	{
		...
		return native_to_managed_trampoline_1 (self, _cmd, &managed_method, "HandOffSample.AppDelegate, HandOffSample, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "get_Window");
	}

	-(void) setWindow:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIWindow, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "HandOffSample.AppDelegate, HandOffSample, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "set_Window");
	}

	-(bool) application:(id)p0 willContinueUserActivityWithType:(NSString *)p1
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_3 (self, _cmd, &managed_method, p0, p1, "MonoTouch.UIKit.UIApplication, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "System.String, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "HandOffSample.AppDelegate, HandOffSample, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "WillContinueUserActivity");
	}

	-(bool) application:(id)p0 continueUserActivity:(id)p1 restorationHandler:(void *)p2
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_4 (self, _cmd, &managed_method, p0, p1, p2, "MonoTouch.UIKit.UIApplication, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "MonoTouch.Foundation.NSUserActivity, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "MonoTouch.UIKit.UIApplicationRestorationHandler, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "HandOffSample.AppDelegate, HandOffSample, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ContinueUserActivity");
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_6 (self, _cmd, &managed_method, "HandOffSample.AppDelegate, HandOffSample, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", ".ctor");
	}
@end
...
@interface HandOffViewController : UIViewController {
	...
	@property (nonatomic, assign) id SharedTextField;
	-(void) release;
	-(id) retain;
	-(void) dealloc;
	-(id) SharedTextField;
	-(void) setSharedTextField:(id)p0;
	-(void) viewDidLoad;
	-(void) restoreUserActivityState:(id)p0;
	-(bool) textFieldShouldReturn:(id)p0;
	-(void) textFieldDidEndEditing:(id)p0;
	-(void) updateUserActivityState:(id)p0;
	-(bool) conformsToProtocol:(void *)p0;
@end
@implementation HandOffViewController { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_1 (self, _cmd, &managed_method, "HandOffSample.HandOffViewController, HandOffSample, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "get_SharedTextField");
	}

	-(void) setSharedTextField:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UITextField, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "HandOffSample.HandOffViewController, HandOffSample, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "set_SharedTextField");
	}

	-(void) viewDidLoad
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_7 (self, _cmd, &managed_method, "HandOffSample.HandOffViewController, HandOffSample, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewDidLoad");
	}

	-(void) restoreUserActivityState:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.Foundation.NSUserActivity, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "HandOffSample.HandOffViewController, HandOffSample, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "RestoreUserActivityState");
	}

	-(bool) textFieldShouldReturn:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_8 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UITextField, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "HandOffSample.HandOffViewController, HandOffSample, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ShouldReturn");
	}

	-(void) textFieldDidEndEditing:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UITextField, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "HandOffSample.HandOffViewController, HandOffSample, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "EditingEnded");
	}

	-(void) updateUserActivityState:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.Foundation.NSUserActivity, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "HandOffSample.HandOffViewController, HandOffSample, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "UpdateUserActivityState");
	}
...
@implementation __UIGestureRecognizerToken { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_6 (self, _cmd, &managed_method, "MonoTouch.UIKit.UIGestureRecognizer+Token, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", ".ctor");
	}
@end
...
@end
	...
	static MTClassMap __monotouch_class_map [] = {
		...
		{"AppDelegate", "HandOffSample.AppDelegate, HandOffSample, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", NULL },
		...
		{"HandOffViewController", "HandOffSample.HandOffViewController, HandOffSample, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", NULL },
...
void monotouch_create_classes () {
	...
	__monotouch_class_map [4].handle = [HandOffViewController class];
	__monotouch_class_map [5].handle = objc_getClass ("NSArray");
	__monotouch_class_map [6].handle = objc_getClass ("NSString");
	__monotouch_class_map [7].handle = objc_getClass ("NSAutoreleasePool");
	...
	__monotouch_class_map [12].handle = objc_getClass ("UITextField");
	...
	__monotouch_class_map [16].handle = objc_getClass ("NSNull");
	__monotouch_class_map [17].handle = objc_getClass ("NSUserActivity");
	__monotouch_class_map [18].handle = objc_getClass ("NSDictionary");
	__monotouch_class_map [19].handle = objc_getClass ("__NSObject_Disposer");
	__monotouch_class_map [20].handle = objc_getClass ("__UIGestureRecognizerToken");
	__monotouch_class_map [21].handle = objc_getClass ("__UIGestureRecognizerParameterlessToken");
	__monotouch_class_map [22].handle = objc_getClass ("__UIGestureRecognizerParametrizedToken");
	__monotouch_class_map [23].handle = objc_getClass ("UIGestureRecognizer");
	__monotouch_class_map [24].handle = objc_getClass ("__UITapGestureRecognizer");
	__monotouch_class_map [25].handle = objc_getClass ("UITapGestureRecognizer");
