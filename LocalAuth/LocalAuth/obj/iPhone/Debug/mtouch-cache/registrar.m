...
@implementation AppDelegate { } 
	...
	-(id) window
	{
		...
		return native_to_managed_trampoline_1 (self, _cmd, &managed_method, "LocalAuth.AppDelegate, LocalAuth, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "get_Window");
	}

	-(void) setWindow:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIWindow, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "LocalAuth.AppDelegate, LocalAuth, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "set_Window");
	}

	-(void) applicationWillResignActive:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIApplication, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "LocalAuth.AppDelegate, LocalAuth, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "OnResignActivation");
	}

	-(void) applicationDidEnterBackground:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIApplication, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "LocalAuth.AppDelegate, LocalAuth, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "DidEnterBackground");
	}

	-(void) applicationWillEnterForeground:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIApplication, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "LocalAuth.AppDelegate, LocalAuth, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "WillEnterForeground");
	}

	-(void) applicationWillTerminate:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIApplication, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "LocalAuth.AppDelegate, LocalAuth, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "WillTerminate");
	}
	...
	{
		static MonoMethod *managed_method = NULL;
		return native_to_managed_trampoline_4 (self, _cmd, &managed_method, "LocalAuth.AppDelegate, LocalAuth, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", ".ctor");
	}
@end
...
@interface LocalAuthViewController : UIViewController {
	...
	-(void) UIButton5_TouchUpInside:(id)p0;
	-(bool) conformsToProtocol:(void *)p0;
@end
@implementation LocalAuthViewController { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_5 (self, _cmd, &managed_method, "LocalAuth.LocalAuthViewController, LocalAuth, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "DidReceiveMemoryWarning");
	}

	-(void) viewDidLoad
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_5 (self, _cmd, &managed_method, "LocalAuth.LocalAuthViewController, LocalAuth, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewDidLoad");
	}

	-(void) viewWillAppear:(bool)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "LocalAuth.LocalAuthViewController, LocalAuth, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewWillAppear");
	}

	-(void) viewDidAppear:(bool)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "LocalAuth.LocalAuthViewController, LocalAuth, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewDidAppear");
	}

	-(void) viewWillDisappear:(bool)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "LocalAuth.LocalAuthViewController, LocalAuth, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewWillDisappear");
	}

	-(void) viewDidDisappear:(bool)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_6 (self, _cmd, &managed_method, p0, "System.Boolean, mscorlib, Version=2.0.5.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e", "LocalAuth.LocalAuthViewController, LocalAuth, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "ViewDidDisappear");
	}

	-(void) UIButton5_TouchUpInside:(id)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_2 (self, _cmd, &managed_method, p0, "MonoTouch.UIKit.UIButton, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", "LocalAuth.LocalAuthViewController, LocalAuth, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", "UIButton5_TouchUpInside");
	}
...
@end
	...
	static MTClassMap __monotouch_class_map [] = {
		...
		{"AppDelegate", "LocalAuth.AppDelegate, LocalAuth, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", NULL },
		...
		{"LocalAuthViewController", "LocalAuth.LocalAuthViewController, LocalAuth, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null", NULL },
		...
		{"LAContext", "MonoTouch.LocalAuthentication.LAContext, monotouch, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", NULL },
...
void monotouch_create_classes () {
	...
	__monotouch_class_map [4].handle = [LocalAuthViewController class];
	...
	__monotouch_class_map [9].handle = objc_getClass ("NSError");
	__monotouch_class_map [10].handle = objc_getClass ("UIView");
	__monotouch_class_map [11].handle = objc_getClass ("UIAlertView");
	...
	__monotouch_class_map [15].handle = objc_getClass ("UIDevice");
	__monotouch_class_map [16].handle = objc_getClass ("UIWindow");
	__monotouch_class_map [17].handle = objc_getClass ("UITraitCollection");
	__monotouch_class_map [18].handle = objc_getClass ("NSException");
	__monotouch_class_map [19].handle = objc_getClass ("LAContext");
	__monotouch_class_map [20].handle = objc_getClass ("NSDictionary");
	__monotouch_class_map [21].handle = objc_getClass ("__NSObject_Disposer");
	monotouch_setup_classmap (__monotouch_class_map, 22);
}
